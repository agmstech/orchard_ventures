...
![version](https://img.shields.io/badge/version-1.9-e8a93a)
...
- **Full camera control** — orbit, zoom, and rotate the garden on the X, Y, and Z axes; add, remove, or drag plots to rearrange them freely. Toggle venture names and info labels independently. Each orchard remembers its own camera view — orbit angle, zoom and tilt — so switching tabs returns it to exactly how you left it.
